...
class Transaction:
    transaction_type = 0
    origin_public_key = None  # String
    origin_signature = None  # Hash
    ...
    def sign_transaction(self,node,identify):
        # content = "{}{}".format(self.transaction_type, node.public_key).encode("utf-8")
        ...
        # print(self.transaction_type, node.public_key.n, node.get_private_key())
        # self.issuing_signature = rsa.sign(io.StringIO(content).encode(), node.get_private_key(), 'SHA-1')
    ...
    def sign_miner_trust(self, node, step):
        ...
        content = "{}{}{}{}{}{}{}".format(self.identify,self.born_step,self.transaction_type, self.origin_public_key,
            self.origin_signature, node.public_key,self.validation_step)
